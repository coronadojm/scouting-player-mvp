...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Landroidx/core/os/Profiling$registerForAllProfilingResults$1;
    .local p1, "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_0

    .end local v0    # "this":Landroidx/core/os/Profiling$registerForAllProfilingResults$1;
    ...
    .local v1, "this":Landroidx/core/os/Profiling$registerForAllProfilingResults$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Landroidx/core/os/Profiling$registerForAllProfilingResults$1;->L$0:Ljava/lang/Object;

    check-cast v2, Lkotlinx/coroutines/channels/ProducerScope;

    .line 74
    .local v2, "$this$callbackFlow":Lkotlinx/coroutines/channels/ProducerScope;
    new-instance v3, Landroidx/core/os/Profiling$registerForAllProfilingResults$1$$ExternalSyntheticLambda0;

    invoke-direct {v3, v2}, Landroidx/core/os/Profiling$registerForAllProfilingResults$1$$ExternalSyntheticLambda0;-><init>(Lkotlinx/coroutines/channels/ProducerScope;)V

    .line 76
    .local v3, "listener":Ljava/util/function/Consumer;
    iget-object v4, v1, Landroidx/core/os/Profiling$registerForAllProfilingResults$1;->$context:Landroid/content/Context;

    const-class v5, Landroid/os/ProfilingManager;

    invoke-virtual {v4, v5}, Landroid/content/Context;->getSystemService(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Landroid/os/ProfilingManager;

    .line 77
    .local v4, "service":Landroid/os/ProfilingManager;
    new-instance v5, Landroidx/core/os/Profiling$registerForAllProfilingResults$1$$ExternalSyntheticLambda1;

    invoke-direct {v5}, Landroidx/core/os/Profiling$registerForAllProfilingResults$1$$ExternalSyntheticLambda1;-><init>()V

    invoke-virtual {v4, v5, v3}, Landroid/os/ProfilingManager;->registerForAllProfilingResults(Ljava/util/concurrent/Executor;Ljava/util/function/Consumer;)V

    .line 79
    new-instance v5, Landroidx/core/os/Profiling$registerForAllProfilingResults$1$2;

    invoke-direct {v5, v4, v3}, Landroidx/core/os/Profiling$registerForAllProfilingResults$1$2;-><init>(Landroid/os/ProfilingManager;Ljava/util/function/Consumer;)V
    ...
    iput v7, v1, Landroidx/core/os/Profiling$registerForAllProfilingResults$1;->label:I
    ...
    .end local v3    # "listener":Ljava/util/function/Consumer;
    .end local v4    # "service":Landroid/os/ProfilingManager;
    if-ne v2, v0, :cond_0
    ...
    .line 80
    .end local v1    # "this":Landroidx/core/os/Profiling$registerForAllProfilingResults$1;
    .restart local v0    # "this":Landroidx/core/os/Profiling$registerForAllProfilingResults$1;
    :goto_0
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
