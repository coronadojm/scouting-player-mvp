...
.method public final invoke(Ljava/util/Set;Landroidx/compose/runtime/snapshots/Snapshot;)V
    ...
    .local v19, "this_$iv$iv":Landroidx/collection/ScatterSet;
    .local v21, "$i$f$synchronized":I
    .local v22, "$i$a$-synchronized-Recomposer$recompositionRunner$2$unregisterApplyObserver$1$1":I
    not-long v7, v3
    ...
    .line 1031
    .local v24, "$i$a$-fastForEach-Recomposer$recompositionRunner$2$unregisterApplyObserver$1$1$1":I
    nop
    ...
    invoke-static/range {v28 .. v28}, Landroidx/compose/runtime/snapshots/ReaderKind;->constructor-impl(I)I
    ...
    invoke-virtual {v1, v8}, Landroidx/compose/runtime/snapshots/StateObjectImpl;->isReadIn-h_f27i8$runtime_release(I)Z
    ...
    .line 1038
    .end local v8    # "index$iv$iv$iv":I
    .restart local v29    # "index$iv$iv$iv":I
    :cond_2
    ...
    .end local v24    # "$i$a$-fastForEach-Recomposer$recompositionRunner$2$unregisterApplyObserver$1$1$1":I
    :goto_3
    nop
    ...
    .end local v19    # "this_$iv$iv":Landroidx/collection/ScatterSet;
    .end local v21    # "$i$f$synchronized":I
    .end local v22    # "$i$a$-synchronized-Recomposer$recompositionRunner$2$unregisterApplyObserver$1$1":I
    .local v3, "$i$f$synchronized":I
    .local v4, "$i$a$-synchronized-Recomposer$recompositionRunner$2$unregisterApplyObserver$1$1":I
    .local v7, "$i$f$fastForEach":I
    .local v8, "this_$iv$iv":Landroidx/collection/ScatterSet;
    ...
    .restart local v19    # "this_$iv$iv":Landroidx/collection/ScatterSet;
    .restart local v21    # "$i$f$synchronized":I
    .restart local v22    # "$i$a$-synchronized-Recomposer$recompositionRunner$2$unregisterApplyObserver$1$1":I
    :cond_7
    nop
    ...
    invoke-virtual {v10, v14}, Landroidx/compose/runtime/snapshots/StateObjectImpl;->isReadIn-h_f27i8$runtime_release(I)Z
