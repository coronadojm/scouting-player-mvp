...
.method public constructor <init>(F)V
    ...
    .local v1, "it":Landroidx/compose/runtime/SnapshotMutableFloatStateImpl$FloatStateStateRecord;
    const/4 v2, 0x0

    .line 133
    .local v2, "$i$a$-also-SnapshotMutableFloatStateImpl$next$1":I
    ...
    .line 134
    new-instance v3, Landroidx/compose/runtime/SnapshotMutableFloatStateImpl$FloatStateStateRecord;

    invoke-direct {v3, p1}, Landroidx/compose/runtime/SnapshotMutableFloatStateImpl$FloatStateStateRecord;-><init>(F)V

    move-object v4, v3

    .local v4, "next":Landroidx/compose/runtime/SnapshotMutableFloatStateImpl$FloatStateStateRecord;
    const/4 v5, 0x0

    .line 135
    .local v5, "$i$a$-also-SnapshotMutableFloatStateImpl$next$1$1":I
    const/4 v6, 0x1

    invoke-virtual {v4, v6}, Landroidx/compose/runtime/SnapshotMutableFloatStateImpl$FloatStateStateRecord;->setSnapshotId$runtime_release(I)V

    .line 136
    nop

    .line 134
    .end local v4    # "next":Landroidx/compose/runtime/SnapshotMutableFloatStateImpl$FloatStateStateRecord;
    .end local v5    # "$i$a$-also-SnapshotMutableFloatStateImpl$next$1$1":I
    check-cast v3, Landroidx/compose/runtime/snapshots/StateRecord;

    invoke-virtual {v1, v3}, Landroidx/compose/runtime/SnapshotMutableFloatStateImpl$FloatStateStateRecord;->setNext$runtime_release(Landroidx/compose/runtime/snapshots/StateRecord;)V
    ...
    .line 132
    .end local v1    # "it":Landroidx/compose/runtime/SnapshotMutableFloatStateImpl$FloatStateStateRecord;
    .end local v2    # "$i$a$-also-SnapshotMutableFloatStateImpl$next$1":I
