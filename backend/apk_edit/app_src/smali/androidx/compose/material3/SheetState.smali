...
.method public constructor <init>(ZLandroidx/compose/ui/unit/Density;Landroidx/compose/material3/SheetValue;Lkotlin/jvm/functions/Function1;Z)V
    .locals 8
    .param p1, "skipPartiallyExpanded"    # Z
    .param p2, "density"    # Landroidx/compose/ui/unit/Density;
    .param p3, "initialValue"    # Landroidx/compose/material3/SheetValue;
    .param p4, "confirmValueChange"    # Lkotlin/jvm/functions/Function1;
    .param p5, "skipHiddenState"    # Z
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
            "Landroidx/compose/ui/unit/Density;",
    ...
    .line 87
    .local v0, "$i$a$-require-SheetState$2":I
    nop

    .line 86
    .end local v0    # "$i$a$-require-SheetState$2":I
    ...
    .line 93
    .local v0, "$i$a$-require-SheetState$3":I
    nop

    .line 92
    .end local v0    # "$i$a$-require-SheetState$3":I
    new-instance v0, Ljava/lang/IllegalArgumentException;
    ...
    .line 243
    new-instance v1, Landroidx/compose/material3/SheetState$anchoredDraggableState$1;

    invoke-direct {v1, p2}, Landroidx/compose/material3/SheetState$anchoredDraggableState$1;-><init>(Landroidx/compose/ui/unit/Density;)V
    ...
    .line 244
    new-instance v1, Landroidx/compose/material3/SheetState$anchoredDraggableState$2;

    invoke-direct {v1, p2}, Landroidx/compose/material3/SheetState$anchoredDraggableState$2;-><init>(Landroidx/compose/ui/unit/Density;)V
    ...
    invoke-direct/range {v2 .. v7}, Landroidx/compose/material3/internal/AnchoredDraggableState;-><init>(Ljava/lang/Object;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function0;Landroidx/compose/animation/core/AnimationSpec;Lkotlin/jvm/functions/Function1;)V
...
.method public final animateTo$material3_release(Landroidx/compose/material3/SheetValue;FLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 2
    .param p1, "targetValue"    # Landroidx/compose/material3/SheetValue;
    .param p2, "velocity"    # F
...
.method public final hide(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 197
    .local v0, "$i$a$-check-SheetState$hide$2":I
    nop

    .line 196
    .end local v0    # "$i$a$-check-SheetState$hide$2":I
...
.method public final partialExpand(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 168
    .local v0, "$i$a$-check-SheetState$partialExpand$2":I
    nop

    .line 167
    .end local v0    # "$i$a$-check-SheetState$partialExpand$2":I
    new-instance v0, Ljava/lang/IllegalStateException;
...
.method public final show(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 186
    .local v2, "targetValue":Landroidx/compose/material3/SheetValue;
    const/4 v5, 0x2
