...
.method public final elevatedFilterChipColors(Landroidx/compose/runtime/Composer;I)Landroidx/compose/material3/SelectableChipColors;
    ...
    invoke-virtual {p0, v0}, Landroidx/compose/material3/FilterChipDefaults;->getDefaultElevatedFilterChipColors$material3_release(Landroidx/compose/material3/ColorScheme;)Landroidx/compose/material3/SelectableChipColors;
...
.method public final elevatedFilterChipColors-XqyqHi0(JJJJJJJJJJJJLandroidx/compose/runtime/Composer;III)Landroidx/compose/material3/SelectableChipColors;
    ...
    .param p7, "disabledContainerColor"    # J
    .param p9, "disabledLabelColor"    # J
    .param p11, "disabledLeadingIconColor"    # J
    .param p13, "disabledTrailingIconColor"    # J
    .param p15, "selectedContainerColor"    # J
    .param p17, "disabledSelectedContainerColor"    # J
    .param p19, "selectedLabelColor"    # J
    .param p21, "selectedLeadingIconColor"    # J
    .param p23, "selectedTrailingIconColor"    # J
    ...
    .end local p5    # "iconColor":J
    .local v5, "iconColor":J
    goto :goto_2

    .line 1454
    .end local v5    # "iconColor":J
    .restart local p5    # "iconColor":J
    :cond_2
    ...
    .end local p7    # "disabledContainerColor":J
    .local v5, "disabledContainerColor":J
    goto :goto_3

    .line 1455
    .end local v5    # "disabledContainerColor":J
    .restart local p7    # "disabledContainerColor":J
    :cond_3
    move-wide/from16 v36, p7

    .line 1456
    .end local p7    # "disabledContainerColor":J
    .local v36, "disabledContainerColor":J
    :goto_3
    ...
    .end local p9    # "disabledLabelColor":J
    .local v5, "disabledLabelColor":J
    goto :goto_4

    .line 1456
    .end local v5    # "disabledLabelColor":J
    .restart local p9    # "disabledLabelColor":J
    :cond_4
    move-wide/from16 v38, p9

    .line 1457
    .end local p9    # "disabledLabelColor":J
    .local v38, "disabledLabelColor":J
    :goto_4
    ...
    .end local p11    # "disabledLeadingIconColor":J
    .local v5, "disabledLeadingIconColor":J
    goto :goto_5

    .line 1457
    .end local v5    # "disabledLeadingIconColor":J
    .restart local p11    # "disabledLeadingIconColor":J
    :cond_5
    move-wide/from16 v40, p11

    .line 1458
    .end local p11    # "disabledLeadingIconColor":J
    .local v40, "disabledLeadingIconColor":J
    :goto_5
    ...
    .end local p13    # "disabledTrailingIconColor":J
    .local v5, "disabledTrailingIconColor":J
    goto :goto_6

    .line 1458
    .end local v5    # "disabledTrailingIconColor":J
    .restart local p13    # "disabledTrailingIconColor":J
    :cond_6
    move-wide/from16 v42, p13

    .line 1459
    .end local p13    # "disabledTrailingIconColor":J
    .local v42, "disabledTrailingIconColor":J
    :goto_6
    ...
    .end local p15    # "selectedContainerColor":J
    .local v5, "selectedContainerColor":J
    goto :goto_7

    .line 1459
    .end local v5    # "selectedContainerColor":J
    .restart local p15    # "selectedContainerColor":J
    :cond_7
    move-wide/from16 v44, p15

    .line 1460
    .end local p15    # "selectedContainerColor":J
    .local v44, "selectedContainerColor":J
    :goto_7
    ...
    .end local p17    # "disabledSelectedContainerColor":J
    .local v5, "disabledSelectedContainerColor":J
    goto :goto_8

    .line 1460
    .end local v5    # "disabledSelectedContainerColor":J
    .restart local p17    # "disabledSelectedContainerColor":J
    :cond_8
    move-wide/from16 v46, p17

    .line 1461
    .end local p17    # "disabledSelectedContainerColor":J
    .local v46, "disabledSelectedContainerColor":J
    :goto_8
    ...
    .end local p19    # "selectedLabelColor":J
    .local v5, "selectedLabelColor":J
    goto :goto_9

    .line 1461
    .end local v5    # "selectedLabelColor":J
    .restart local p19    # "selectedLabelColor":J
    :cond_9
    move-wide/from16 v48, p19

    .line 1462
    .end local p19    # "selectedLabelColor":J
    .local v48, "selectedLabelColor":J
    :goto_9
    ...
    .end local p21    # "selectedLeadingIconColor":J
    .local v5, "selectedLeadingIconColor":J
    goto :goto_a

    .line 1462
    .end local v5    # "selectedLeadingIconColor":J
    .restart local p21    # "selectedLeadingIconColor":J
    :cond_a
    move-wide/from16 v50, p21

    .line 1463
    .end local p21    # "selectedLeadingIconColor":J
    .local v50, "selectedLeadingIconColor":J
    :goto_a
    ...
    .end local p23    # "selectedTrailingIconColor":J
    .local v5, "selectedTrailingIconColor":J
    goto :goto_b

    .line 1463
    .end local v5    # "selectedTrailingIconColor":J
    .restart local p23    # "selectedTrailingIconColor":J
    :cond_b
    move-wide/from16 v52, p23

    .line 1464
    .end local p23    # "selectedTrailingIconColor":J
    .local v52, "selectedTrailingIconColor":J
    :goto_b
    invoke-static {}, Landroidx/compose/runtime/ComposerKt;->isTraceInProgress()Z
...
.method public final elevatedFilterChipElevation-aqJV_2Y(FFFFFFLandroidx/compose/runtime/Composer;II)Landroidx/compose/material3/SelectableChipElevation;
    ...
    invoke-virtual {v1}, Landroidx/compose/material3/tokens/FilterChipTokens;->getElevatedContainerElevation-D9Ej5fM()F
    ...
    invoke-virtual {v3}, Landroidx/compose/material3/tokens/FilterChipTokens;->getElevatedPressedContainerElevation-D9Ej5fM()F
    ...
    invoke-virtual {v3}, Landroidx/compose/material3/tokens/FilterChipTokens;->getElevatedFocusContainerElevation-D9Ej5fM()F
    ...
    invoke-virtual {v3}, Landroidx/compose/material3/tokens/FilterChipTokens;->getElevatedHoverContainerElevation-D9Ej5fM()F
    ...
    invoke-virtual {v3}, Landroidx/compose/material3/tokens/FilterChipTokens;->getDraggedContainerElevation-D9Ej5fM()F
    ...
    invoke-virtual {v3}, Landroidx/compose/material3/tokens/FilterChipTokens;->getElevatedDisabledContainerElevation-D9Ej5fM()F
...
.method public final filterChipBorder-_7El2pE(ZZJJJJFFLandroidx/compose/runtime/Composer;II)Landroidx/compose/foundation/BorderStroke;
    ...
    .param p5, "selectedBorderColor"    # J
    .param p7, "disabledBorderColor"    # J
    .param p9, "disabledSelectedBorderColor"    # J
    .param p11, "borderWidth"    # F
    .param p12, "selectedBorderWidth"    # F
    ...
    .end local p3    # "borderColor":J
    .local v5, "borderColor":J
    goto :goto_0

    .line 1416
    .end local v5    # "borderColor":J
    .restart local p3    # "borderColor":J
    :cond_0
    move-wide/from16 v5, p3

    .line 1407
    .end local p3    # "borderColor":J
    .restart local v5    # "borderColor":J
    :goto_0
    ...
    .end local p5    # "selectedBorderColor":J
    .local v7, "selectedBorderColor":J
    goto :goto_1

    .line 1407
    .end local v7    # "selectedBorderColor":J
    .restart local p5    # "selectedBorderColor":J
    :cond_1
    move-wide/from16 v7, p5

    .line 1408
    .end local p5    # "selectedBorderColor":J
    .restart local v7    # "selectedBorderColor":J
    :goto_1
    ...
    invoke-virtual {v3}, Landroidx/compose/material3/tokens/FilterChipTokens;->getFlatDisabledUnselectedOutlineOpacity()F
    ...
    .end local p7    # "disabledBorderColor":J
    .local v3, "disabledBorderColor":J
    goto :goto_2

    .line 1408
    .end local v3    # "disabledBorderColor":J
    .restart local p7    # "disabledBorderColor":J
    :cond_2
    move-wide/from16 v3, p7

    .line 1410
    .end local p7    # "disabledBorderColor":J
    .restart local v3    # "disabledBorderColor":J
    :goto_2
    ...
    .end local p9    # "disabledSelectedBorderColor":J
    .local v9, "disabledSelectedBorderColor":J
    goto :goto_3

    .line 1410
    .end local v9    # "disabledSelectedBorderColor":J
    .restart local p9    # "disabledSelectedBorderColor":J
    :cond_3
    move-wide/from16 v9, p9

    .line 1413
    .end local p9    # "disabledSelectedBorderColor":J
    .restart local v9    # "disabledSelectedBorderColor":J
    :goto_3
    ...
    .end local p11    # "borderWidth":F
    .local v11, "borderWidth":F
    goto :goto_4

    .line 1413
    .end local v11    # "borderWidth":F
    .restart local p11    # "borderWidth":F
    :cond_4
    move/from16 v11, p11

    .line 1414
    .end local p11    # "borderWidth":F
    .restart local v11    # "borderWidth":F
    :goto_4
    ...
    .end local p12    # "selectedBorderWidth":F
    .local v1, "selectedBorderWidth":F
    goto :goto_5

    .line 1414
    .end local v1    # "selectedBorderWidth":F
    .restart local p12    # "selectedBorderWidth":F
    :cond_5
    move/from16 v1, p12

    .line 1415
    .end local p12    # "selectedBorderWidth":F
    .restart local v1    # "selectedBorderWidth":F
    :goto_5
    invoke-static {}, Landroidx/compose/runtime/ComposerKt;->isTraceInProgress()Z
...
.method public final filterChipColors(Landroidx/compose/runtime/Composer;I)Landroidx/compose/material3/SelectableChipColors;
    ...
    invoke-virtual {p0, v0}, Landroidx/compose/material3/FilterChipDefaults;->getDefaultFilterChipColors$material3_release(Landroidx/compose/material3/ColorScheme;)Landroidx/compose/material3/SelectableChipColors;
...
.method public final filterChipElevation-aqJV_2Y(FFFFFFLandroidx/compose/runtime/Composer;II)Landroidx/compose/material3/SelectableChipElevation;
    ...
    invoke-virtual {v1}, Landroidx/compose/material3/tokens/FilterChipTokens;->getFlatContainerElevation-D9Ej5fM()F
    ...
    invoke-virtual {v3}, Landroidx/compose/material3/tokens/FilterChipTokens;->getFlatSelectedPressedContainerElevation-D9Ej5fM()F
    ...
    invoke-virtual {v3}, Landroidx/compose/material3/tokens/FilterChipTokens;->getFlatSelectedFocusContainerElevation-D9Ej5fM()F
    ...
    invoke-virtual {v3}, Landroidx/compose/material3/tokens/FilterChipTokens;->getFlatSelectedHoverContainerElevation-D9Ej5fM()F
...
.method public final getDefaultElevatedFilterChipColors$material3_release(Landroidx/compose/material3/ColorScheme;)Landroidx/compose/material3/SelectableChipColors;
    .locals 31
    .param p1, "$this$defaultElevatedFilterChipColors"    # Landroidx/compose/material3/ColorScheme;
    ...
    .line 1489
    sget-object v7, Landroidx/compose/material3/tokens/FilterChipTokens;->INSTANCE:Landroidx/compose/material3/tokens/FilterChipTokens;

    invoke-virtual {v7}, Landroidx/compose/material3/tokens/FilterChipTokens;->getUnselectedLeadingIconColor()Landroidx/compose/material3/tokens/ColorSchemeKeyTokens;
    ...
    invoke-virtual {v9}, Landroidx/compose/material3/tokens/FilterChipTokens;->getUnselectedLeadingIconColor()Landroidx/compose/material3/tokens/ColorSchemeKeyTokens;
    ...
    invoke-virtual {v11}, Landroidx/compose/material3/tokens/FilterChipTokens;->getElevatedDisabledContainerColor()Landroidx/compose/material3/tokens/ColorSchemeKeyTokens;
    ...
    invoke-virtual {v11}, Landroidx/compose/material3/tokens/FilterChipTokens;->getElevatedDisabledContainerOpacity()F
    ...
    invoke-virtual {v13}, Landroidx/compose/material3/tokens/FilterChipTokens;->getDisabledLabelTextColor()Landroidx/compose/material3/tokens/ColorSchemeKeyTokens;
    ...
    invoke-virtual {v13}, Landroidx/compose/material3/tokens/FilterChipTokens;->getDisabledLabelTextOpacity()F
    ...
    .line 1498
    sget-object v15, Landroidx/compose/material3/tokens/FilterChipTokens;->INSTANCE:Landroidx/compose/material3/tokens/FilterChipTokens;

    invoke-virtual {v15}, Landroidx/compose/material3/tokens/FilterChipTokens;->getDisabledLeadingIconColor()Landroidx/compose/material3/tokens/ColorSchemeKeyTokens;
    ...
    invoke-virtual {v15}, Landroidx/compose/material3/tokens/FilterChipTokens;->getDisabledLeadingIconOpacity()F
    ...
    .line 1501
    sget-object v17, Landroidx/compose/material3/tokens/FilterChipTokens;->INSTANCE:Landroidx/compose/material3/tokens/FilterChipTokens;

    move-object/from16 v30, v1

    invoke-virtual/range {v17 .. v17}, Landroidx/compose/material3/tokens/FilterChipTokens;->getDisabledLeadingIconColor()Landroidx/compose/material3/tokens/ColorSchemeKeyTokens;
    ...
    invoke-virtual {v1}, Landroidx/compose/material3/tokens/FilterChipTokens;->getElevatedSelectedContainerColor()Landroidx/compose/material3/tokens/ColorSchemeKeyTokens;
    ...
    invoke-virtual {v1}, Landroidx/compose/material3/tokens/FilterChipTokens;->getSelectedLabelTextColor()Landroidx/compose/material3/tokens/ColorSchemeKeyTokens;
    ...
    invoke-virtual {v1}, Landroidx/compose/material3/tokens/FilterChipTokens;->getSelectedLeadingIconColor()Landroidx/compose/material3/tokens/ColorSchemeKeyTokens;
    ...
    .line 2788
    .local v1, "it":Landroidx/compose/material3/SelectableChipColors;
    const/4 v2, 0x0

    .line 1514
    .local v2, "$i$a$-also-FilterChipDefaults$defaultElevatedFilterChipColors$1":I
    ...
    .line 1484
    .end local v1    # "it":Landroidx/compose/material3/SelectableChipColors;
    .end local v2    # "$i$a$-also-FilterChipDefaults$defaultElevatedFilterChipColors$1":I
    :cond_0
    return-object v1
.end method
...
.method public final getDefaultFilterChipColors$material3_release(Landroidx/compose/material3/ColorScheme;)Landroidx/compose/material3/SelectableChipColors;
    .locals 31
    .param p1, "$this$defaultFilterChipColors"    # Landroidx/compose/material3/ColorScheme;
    ...
    invoke-virtual {v1}, Landroidx/compose/material3/tokens/FilterChipTokens;->getFlatSelectedContainerColor()Landroidx/compose/material3/tokens/ColorSchemeKeyTokens;
    ...
    invoke-virtual {v1}, Landroidx/compose/material3/tokens/FilterChipTokens;->getFlatDisabledSelectedContainerColor()Landroidx/compose/material3/tokens/ColorSchemeKeyTokens;
    ...
    invoke-virtual {v1}, Landroidx/compose/material3/tokens/FilterChipTokens;->getFlatDisabledSelectedContainerOpacity()F
    ...
    .line 1356
    .local v2, "$i$a$-also-FilterChipDefaults$defaultFilterChipColors$1":I
    ...
    .line 1327
    .end local v1    # "it":Landroidx/compose/material3/SelectableChipColors;
    .end local v2    # "$i$a$-also-FilterChipDefaults$defaultFilterChipColors$1":I
    :cond_0
    return-object v1
.end method
...
.method public final getShape(Landroidx/compose/runtime/Composer;I)Landroidx/compose/ui/graphics/Shape;
    ...
    invoke-virtual {v0}, Landroidx/compose/material3/tokens/FilterChipTokens;->getContainerShape()Landroidx/compose/material3/tokens/ShapeKeyTokens;
