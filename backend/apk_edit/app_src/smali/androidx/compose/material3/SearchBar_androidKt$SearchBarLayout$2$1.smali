...
.method public final measure-3p2s80s(Landroidx/compose/ui/layout/MeasureScope;Ljava/util/List;J)Landroidx/compose/ui/layout/MeasureResult;
    ...
    .line 970
    .local v11, "inputFieldMeasurable":Landroidx/compose/ui/layout/Measurable;
    move-object/from16 v1, p2
    ...
    .line 971
    .local v7, "surfaceMeasurable":Landroidx/compose/ui/layout/Measurable;
    move-object/from16 v1, p2
    ...
    .line 973
    .local v6, "contentMeasurable":Landroidx/compose/ui/layout/Measurable;
    ...
    .line 991
    .local v14, "predictiveBackStartHeight":I
    ...
    .line 993
    iget-object v12, v0, Landroidx/compose/material3/SearchBar_androidKt$SearchBarLayout$2$1;->$finalBackProgress:Landroidx/compose/runtime/MutableFloatState;

    invoke-interface {v12}, Landroidx/compose/runtime/MutableFloatState;->getFloatValue()F

    move-result v12

    .line 990
    invoke-static {v10, v13, v12}, Landroidx/compose/material3/SearchBar_androidKt;->access$calculatePredictiveBackMultiplier(Landroidx/activity/BackEventCompat;FF)F
    ...
    .line 996
    .local v10, "predictiveBackMultiplier":F
    invoke-static {v4, v1, v10}, Landroidx/compose/ui/util/MathHelpersKt;->lerp(IIF)I
    ...
    .line 998
    invoke-static {v1, v14, v10}, Landroidx/compose/ui/util/MathHelpersKt;->lerp(IIF)I
    ...
    invoke-static {v12, v15, v13}, Landroidx/compose/ui/util/MathHelpersKt;->lerp(IIF)I

    move-result v8

    .line 1008
    .local v8, "minWidth":I
    invoke-static {v1, v9, v13}, Landroidx/compose/ui/util/MathHelpersKt;->lerp(IIF)I
    ...
    invoke-static {v5, v1, v13}, Landroidx/compose/ui/util/MathHelpersKt;->lerp(IIF)I

    move-result v20

    .line 1012
    .local v20, "animatedTopPadding":I
    invoke-static {v1, v3, v13}, Landroidx/compose/ui/util/MathHelpersKt;->lerp(IIF)I
    ...
    .end local v10    # "predictiveBackMultiplier":F
    .local v22, "predictiveBackMultiplier":F
    .local v23, "maxHeight":I
    invoke-static {v8, v15, v2, v2}, Landroidx/compose/ui/unit/ConstraintsKt;->Constraints(IIII)J
    ...
    .end local v11    # "inputFieldMeasurable":Landroidx/compose/ui/layout/Measurable;
    .local v26, "inputFieldMeasurable":Landroidx/compose/ui/layout/Measurable;
    invoke-virtual {v10, v9, v1}, Landroidx/compose/ui/unit/Constraints$Companion;->fixed-JhjzzOo(II)J
    ...
    .end local v2    # "defaultStartHeight":I
    .local v25, "defaultStartHeight":I
    invoke-static {v9, v9, v11, v1}, Landroidx/compose/ui/unit/ConstraintsKt;->Constraints(IIII)J
    ...
    .end local v25    # "defaultStartHeight":I
    .restart local v2    # "defaultStartHeight":I
    :cond_3
    move/from16 v25, v2

    .end local v2    # "defaultStartHeight":I
    .restart local v25    # "defaultStartHeight":I
    const/4 v1, 0x0
    ...
    .end local v14    # "predictiveBackStartHeight":I
    .local v19, "predictiveBackStartHeight":I
    move-object v14, v1

    .line 1046
    .local v14, "contentPlaceable":Landroidx/compose/ui/layout/Placeable;
    new-instance v27, Landroidx/compose/material3/SearchBar_androidKt$SearchBarLayout$2$1$1;

    iget-object v11, v0, Landroidx/compose/material3/SearchBar_androidKt$SearchBarLayout$2$1;->$currentBackEvent:Landroidx/compose/runtime/MutableState;

    iget-object v2, v0, Landroidx/compose/material3/SearchBar_androidKt$SearchBarLayout$2$1;->$firstBackEvent:Landroidx/compose/runtime/MutableState;
    ...
    .end local v4    # "defaultStartWidth":I
    .local v29, "bottomPadding":I
    .local v30, "defaultStartWidth":I
    ...
    .end local v6    # "contentMeasurable":Landroidx/compose/ui/layout/Measurable;
    .local v32, "contentMeasurable":Landroidx/compose/ui/layout/Measurable;
    move v6, v13

    move-object/from16 v33, v7

    .end local v7    # "surfaceMeasurable":Landroidx/compose/ui/layout/Measurable;
    .local v33, "surfaceMeasurable":Landroidx/compose/ui/layout/Measurable;
    move/from16 v7, v22
    ...
    .end local v13    # "animationProgress":F
    .local v35, "animationProgress":F
    move/from16 v13, v31
    ...
    .end local v22    # "predictiveBackMultiplier":F
    ...
    .end local v29    # "bottomPadding":I
    .end local v30    # "defaultStartWidth":I
    .end local v31    # "topPadding":I
    .end local v32    # "contentMeasurable":Landroidx/compose/ui/layout/Measurable;
    .end local v33    # "surfaceMeasurable":Landroidx/compose/ui/layout/Measurable;
    .end local v34    # "minWidth":I
    .end local v35    # "animationProgress":F
    .end local v36    # "maxWidth":I
    .local v3, "$this$fastForEach$iv$iv":Ljava/util/List;
    .local v4, "$i$f$fastForEach":I
    .local v5, "index$iv$iv":I
    .local v10, "item$iv$iv":Ljava/lang/Object;
    .restart local v11    # "inputFieldMeasurable":Landroidx/compose/ui/layout/Measurable;
    .local v12, "it$iv":Ljava/lang/Object;
    .restart local v13    # "animationProgress":F
    .local v14, "$i$a$-fastForEach-ListUtilsKt$fastFirst$2$iv":I
    .local v18, "$this$fastFirst$iv":Ljava/util/List;
    .local v19, "$i$f$fastFirst":I
    :cond_4
    ...
    .restart local v35    # "animationProgress":F
    nop
