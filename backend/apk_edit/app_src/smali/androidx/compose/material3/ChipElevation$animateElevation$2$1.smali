...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    new-instance v7, Landroidx/compose/material3/ChipElevation$animateElevation$2$1;
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Landroidx/compose/material3/ChipElevation$animateElevation$2$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Landroidx/compose/material3/ChipElevation$animateElevation$2$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Landroidx/compose/material3/ChipElevation$animateElevation$2$1;
    .local p1, "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_1

    .end local v0    # "this":Landroidx/compose/material3/ChipElevation$animateElevation$2$1;
    .end local p1    # "$result":Ljava/lang/Object;
    :pswitch_1
    move-object v0, p0

    .restart local v0    # "this":Landroidx/compose/material3/ChipElevation$animateElevation$2$1;
    ...
    .line 2238
    .local v1, "this":Landroidx/compose/material3/ChipElevation$animateElevation$2$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Landroidx/compose/material3/ChipElevation$animateElevation$2$1;->$animatable:Landroidx/compose/animation/core/Animatable;
    ...
    iget v3, v1, Landroidx/compose/material3/ChipElevation$animateElevation$2$1;->$target:F
    ...
    .line 2239
    iget-boolean v2, v1, Landroidx/compose/material3/ChipElevation$animateElevation$2$1;->$enabled:Z
    ...
    iput v5, v1, Landroidx/compose/material3/ChipElevation$animateElevation$2$1;->label:I
    ...
    .end local v1    # "this":Landroidx/compose/material3/ChipElevation$animateElevation$2$1;
    .restart local v0    # "this":Landroidx/compose/material3/ChipElevation$animateElevation$2$1;
    :goto_0
    move-object v1, v0
    ...
    .line 2244
    .end local v0    # "this":Landroidx/compose/material3/ChipElevation$animateElevation$2$1;
    .restart local v1    # "this":Landroidx/compose/material3/ChipElevation$animateElevation$2$1;
    :cond_1
    iget-object v2, v1, Landroidx/compose/material3/ChipElevation$animateElevation$2$1;->$lastInteraction$delegate:Landroidx/compose/runtime/MutableState;

    invoke-static {v2}, Landroidx/compose/material3/ChipElevation;->access$animateElevation$lambda$2(Landroidx/compose/runtime/MutableState;)Landroidx/compose/foundation/interaction/Interaction;

    move-result-object v2

    .line 2243
    iget-object v3, v1, Landroidx/compose/material3/ChipElevation$animateElevation$2$1;->$animatable:Landroidx/compose/animation/core/Animatable;

    .line 2246
    iget v4, v1, Landroidx/compose/material3/ChipElevation$animateElevation$2$1;->$target:F

    .line 2244
    nop

    .line 2245
    iget-object v5, v1, Landroidx/compose/material3/ChipElevation$animateElevation$2$1;->$interaction:Landroidx/compose/foundation/interaction/Interaction;
    ...
    iput v7, v1, Landroidx/compose/material3/ChipElevation$animateElevation$2$1;->label:I
    ...
    .restart local v1    # "this":Landroidx/compose/material3/ChipElevation$animateElevation$2$1;
    :goto_2
    iget-object v0, v1, Landroidx/compose/material3/ChipElevation$animateElevation$2$1;->$lastInteraction$delegate:Landroidx/compose/runtime/MutableState;

    iget-object v2, v1, Landroidx/compose/material3/ChipElevation$animateElevation$2$1;->$interaction:Landroidx/compose/foundation/interaction/Interaction;

    invoke-static {v0, v2}, Landroidx/compose/material3/ChipElevation;->access$animateElevation$lambda$3(Landroidx/compose/runtime/MutableState;Landroidx/compose/foundation/interaction/Interaction;)V
