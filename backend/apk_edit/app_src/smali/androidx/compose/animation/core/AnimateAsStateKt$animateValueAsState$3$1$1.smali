...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Landroidx/compose/animation/core/AnimateAsStateKt$animateValueAsState$3$1$1;
    .local p1, "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_0

    .end local v0    # "this":Landroidx/compose/animation/core/AnimateAsStateKt$animateValueAsState$3$1$1;
    ...
    .line 427
    .local v1, "this":Landroidx/compose/animation/core/AnimateAsStateKt$animateValueAsState$3$1$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Landroidx/compose/animation/core/AnimateAsStateKt$animateValueAsState$3$1$1;->$newTarget:Ljava/lang/Object;

    iget-object v3, v1, Landroidx/compose/animation/core/AnimateAsStateKt$animateValueAsState$3$1$1;->$animatable:Landroidx/compose/animation/core/Animatable;
    ...
    iget-object v4, v1, Landroidx/compose/animation/core/AnimateAsStateKt$animateValueAsState$3$1$1;->$newTarget:Ljava/lang/Object;

    iget-object v2, v1, Landroidx/compose/animation/core/AnimateAsStateKt$animateValueAsState$3$1$1;->$animSpec$delegate:Landroidx/compose/runtime/State;

    invoke-static {v2}, Landroidx/compose/animation/core/AnimateAsStateKt;->access$animateValueAsState$lambda$6(Landroidx/compose/runtime/State;)Landroidx/compose/animation/core/AnimationSpec;
    ...
    iput v2, v1, Landroidx/compose/animation/core/AnimateAsStateKt$animateValueAsState$3$1$1;->label:I
    ...
    .line 429
    .end local v1    # "this":Landroidx/compose/animation/core/AnimateAsStateKt$animateValueAsState$3$1$1;
    .restart local v0    # "this":Landroidx/compose/animation/core/AnimateAsStateKt$animateValueAsState$3$1$1;
    :goto_0
    iget-object v1, v0, Landroidx/compose/animation/core/AnimateAsStateKt$animateValueAsState$3$1$1;->$listener$delegate:Landroidx/compose/runtime/State;

    invoke-static {v1}, Landroidx/compose/animation/core/AnimateAsStateKt;->access$animateValueAsState$lambda$4(Landroidx/compose/runtime/State;)Lkotlin/jvm/functions/Function1;

    move-result-object v1

    if-eqz v1, :cond_1

    iget-object v2, v0, Landroidx/compose/animation/core/AnimateAsStateKt$animateValueAsState$3$1$1;->$animatable:Landroidx/compose/animation/core/Animatable;
    ...
    .end local v0    # "this":Landroidx/compose/animation/core/AnimateAsStateKt$animateValueAsState$3$1$1;
    .restart local v1    # "this":Landroidx/compose/animation/core/AnimateAsStateKt$animateValueAsState$3$1$1;
    :cond_2
