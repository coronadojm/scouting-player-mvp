...
.method public static final measure(Landroidx/compose/foundation/layout/RowColumnMeasurePolicy;IIIIILandroidx/compose/ui/layout/MeasureScope;Ljava/util/List;[Landroidx/compose/ui/layout/Placeable;II[II)Landroidx/compose/ui/layout/MeasureResult;
    ...
    .local v0, "exception$iv":Ljava/lang/IllegalArgumentException;
    const/4 v1, 0x0

    .line 362
    .local v1, "$i$f$initCause":I
    ...
    .end local v0    # "exception$iv":Ljava/lang/IllegalArgumentException;
    .end local v1    # "$i$f$initCause":I
    throw v0
    ...
    .local v1, "exception$iv":Ljava/lang/IllegalArgumentException;
    const/4 v2, 0x0

    .line 366
    .local v2, "$i$f$initCause":I
    move-object v3, v0
    ...
    .end local v1    # "exception$iv":Ljava/lang/IllegalArgumentException;
    .end local v2    # "$i$f$initCause":I
    throw v1
