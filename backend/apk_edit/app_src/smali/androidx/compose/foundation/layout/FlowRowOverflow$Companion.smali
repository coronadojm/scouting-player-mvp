...
.method public final expandIndicator(Lkotlin/jvm/functions/Function3;)Landroidx/compose/foundation/layout/FlowRowOverflow;
    ...
    .line 110
    new-instance v0, Landroidx/compose/foundation/layout/FlowRowOverflow$Companion$expandIndicator$seeMoreGetter$1;

    invoke-direct {v0, p1}, Landroidx/compose/foundation/layout/FlowRowOverflow$Companion$expandIndicator$seeMoreGetter$1;-><init>(Lkotlin/jvm/functions/Function3;)V

    check-cast v0, Lkotlin/jvm/functions/Function1;

    .line 116
    .local v0, "seeMoreGetter":Lkotlin/jvm/functions/Function1;
    new-instance v9, Landroidx/compose/foundation/layout/FlowRowOverflow;
    ...
    invoke-direct/range {v1 .. v8}, Landroidx/compose/foundation/layout/FlowRowOverflow;-><init>(Landroidx/compose/foundation/layout/FlowLayoutOverflow$OverflowType;IILkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method public final expandOrCollapseIndicator--jt2gSs(Lkotlin/jvm/functions/Function3;Lkotlin/jvm/functions/Function3;IFLandroidx/compose/runtime/Composer;II)Landroidx/compose/foundation/layout/FlowRowOverflow;
    ...
    .param p4, "minHeightToShowCollapse"    # F
    ...
    const-string v5, "C(expandOrCollapseIndicator)P(1!1,3,2:c#ui.unit.Dp)*155@7080L7,158@7176L1079:FlowLayoutOverflow.kt#2w3rfo"
    ...
    .line 153
    .end local p3    # "minRowsToShowCollapse":I
    .restart local v5    # "minRowsToShowCollapse":I
    :goto_0
    ...
    .end local p4    # "minHeightToShowCollapse":F
    .local v6, "minHeightToShowCollapse":F
    goto :goto_1

    .line 153
    .end local v6    # "minHeightToShowCollapse":F
    .restart local p4    # "minHeightToShowCollapse":F
    :cond_1
    move/from16 v13, p4

    .line 907
    .end local p4    # "minHeightToShowCollapse":F
    .local v13, "minHeightToShowCollapse":F
    :goto_1
    ...
    const-string v7, "androidx.compose.foundation.layout.FlowRowOverflow.Companion.expandOrCollapseIndicator (FlowLayoutOverflow.kt:154)"
    ...
    .line 157
    .local v6, "$i$a$-with-FlowRowOverflow$Companion$expandOrCollapseIndicator$minHeightToShowCollapsePx$1":I
    ...
    .end local v6    # "$i$a$-with-FlowRowOverflow$Companion$expandOrCollapseIndicator$minHeightToShowCollapsePx$1":I
    nop

    .line 159
    .local v4, "minHeightToShowCollapsePx":I
    const v6, -0x7e8a0b0
    ...
    .line 165
    .local v18, "$i$a$-cache-FlowRowOverflow$Companion$expandOrCollapseIndicator$1":I
    new-instance v6, Landroidx/compose/foundation/layout/FlowRowOverflow$Companion$expandOrCollapseIndicator$1$seeMoreGetter$1;

    invoke-direct {v6, v0}, Landroidx/compose/foundation/layout/FlowRowOverflow$Companion$expandOrCollapseIndicator$1$seeMoreGetter$1;-><init>(Lkotlin/jvm/functions/Function3;)V
    ...
    new-instance v6, Landroidx/compose/foundation/layout/FlowRowOverflow$Companion$expandOrCollapseIndicator$1$collapseGetter$1;

    invoke-direct {v6, v1}, Landroidx/compose/foundation/layout/FlowRowOverflow$Companion$expandOrCollapseIndicator$1$collapseGetter$1;-><init>(Lkotlin/jvm/functions/Function3;)V
    ...
    new-instance v21, Landroidx/compose/foundation/layout/FlowRowOverflow;
    ...
    invoke-direct/range {v6 .. v12}, Landroidx/compose/foundation/layout/FlowRowOverflow;-><init>(Landroidx/compose/foundation/layout/FlowLayoutOverflow$OverflowType;IILkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    .line 911
    .end local v18    # "$i$a$-cache-FlowRowOverflow$Companion$expandOrCollapseIndicator$1":I
    ...
    check-cast v12, Landroidx/compose/foundation/layout/FlowRowOverflow;
