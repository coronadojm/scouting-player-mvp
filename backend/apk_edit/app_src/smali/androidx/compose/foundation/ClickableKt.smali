...
.method public static final CombinedClickableNode-nSzSaCc(Lkotlin/jvm/functions/Function0;Ljava/lang/String;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;Landroidx/compose/foundation/interaction/MutableInteractionSource;Landroidx/compose/foundation/IndicationNodeFactory;ZLjava/lang/String;Landroidx/compose/ui/semantics/Role;)Landroidx/compose/foundation/CombinedClickableNode;
    ...
    .param p1, "onLongClickLabel"    # Ljava/lang/String;
    .param p2, "onLongClick"    # Lkotlin/jvm/functions/Function0;
    .param p3, "onDoubleClick"    # Lkotlin/jvm/functions/Function0;
    .param p4, "interactionSource"    # Landroidx/compose/foundation/interaction/MutableInteractionSource;
    .param p5, "indicationNodeFactory"    # Landroidx/compose/foundation/IndicationNodeFactory;
    .param p6, "enabled"    # Z
...
.method public static final clickable-O2vRcR0(Landroidx/compose/ui/Modifier;Landroidx/compose/foundation/interaction/MutableInteractionSource;Landroidx/compose/foundation/Indication;ZLjava/lang/String;Landroidx/compose/ui/semantics/Role;Lkotlin/jvm/functions/Function0;)Landroidx/compose/ui/Modifier;
    ...
    .local v1, "intSource":Landroidx/compose/foundation/interaction/MutableInteractionSource;
    const/4 v12, 0x0

    .line 186
    .local v12, "$i$a$-clickableWithIndicationIfNeeded-ClickableKt$clickable$3":I
    new-instance v13, Landroidx/compose/foundation/ClickableElement;
    ...
    .line 1305
    .end local v1    # "intSource":Landroidx/compose/foundation/interaction/MutableInteractionSource;
    .end local v11    # "indicationNodeFactory":Landroidx/compose/foundation/IndicationNodeFactory;
    .end local v12    # "$i$a$-clickableWithIndicationIfNeeded-ClickableKt$clickable$3":I
    goto/16 :goto_0
    ...
    .restart local v1    # "intSource":Landroidx/compose/foundation/interaction/MutableInteractionSource;
    const/4 v12, 0x0

    .line 186
    .restart local v12    # "$i$a$-clickableWithIndicationIfNeeded-ClickableKt$clickable$3":I
    new-instance v13, Landroidx/compose/foundation/ClickableElement;
    ...
    .line 186
    .local v13, "$i$a$-clickableWithIndicationIfNeeded-ClickableKt$clickable$3":I
    new-instance v14, Landroidx/compose/foundation/ClickableElement;
    ...
    .end local v13    # "$i$a$-clickableWithIndicationIfNeeded-ClickableKt$clickable$3":I
...
.method public static final clickableWithIndicationIfNeeded(Landroidx/compose/ui/Modifier;Landroidx/compose/foundation/interaction/MutableInteractionSource;Landroidx/compose/foundation/Indication;Lkotlin/jvm/functions/Function2;)Landroidx/compose/ui/Modifier;
    .locals 5
    .param p0, "$this$clickableWithIndicationIfNeeded"    # Landroidx/compose/ui/Modifier;
    .param p1, "interactionSource"    # Landroidx/compose/foundation/interaction/MutableInteractionSource;
    .param p2, "indication"    # Landroidx/compose/foundation/Indication;
    .param p3, "createClickable"    # Lkotlin/jvm/functions/Function2;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroidx/compose/ui/Modifier;",
    ...
    .line 363
    .local v0, "$i$f$clickableWithIndicationIfNeeded":I
    nop
    ...
    invoke-static {v2, v3, p2}, Landroidx/compose/foundation/IndicationKt;->indication(Landroidx/compose/ui/Modifier;Landroidx/compose/foundation/interaction/InteractionSource;Landroidx/compose/foundation/Indication;)Landroidx/compose/ui/Modifier;
    ...
    new-instance v3, Landroidx/compose/foundation/ClickableKt$clickableWithIndicationIfNeeded$1;

    invoke-direct {v3, p2, p3}, Landroidx/compose/foundation/ClickableKt$clickableWithIndicationIfNeeded$1;-><init>(Landroidx/compose/foundation/Indication;Lkotlin/jvm/functions/Function2;)V

    check-cast v3, Lkotlin/jvm/functions/Function3;

    const/4 v4, 0x1

    invoke-static {v2, v1, v3, v4, v1}, Landroidx/compose/ui/ComposedModifierKt;->composed$default(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function3;ILjava/lang/Object;)Landroidx/compose/ui/Modifier;
...
.method public static final combinedClickable-XVZzFYc(Landroidx/compose/ui/Modifier;Landroidx/compose/foundation/interaction/MutableInteractionSource;Landroidx/compose/foundation/Indication;ZLjava/lang/String;Landroidx/compose/ui/semantics/Role;Ljava/lang/String;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;)Landroidx/compose/ui/Modifier;
    .locals 18
    .param p0, "$this$combinedClickable_u2dXVZzFYc"    # Landroidx/compose/ui/Modifier;
    .param p1, "interactionSource"    # Landroidx/compose/foundation/interaction/MutableInteractionSource;
    .param p2, "indication"    # Landroidx/compose/foundation/Indication;
    .param p3, "enabled"    # Z
    .param p4, "onClickLabel"    # Ljava/lang/String;
    ...
    .param p9, "onClick"    # Lkotlin/jvm/functions/Function0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroidx/compose/ui/Modifier;",
    ...
    .local v12, "$this$clickableWithIndicationIfNeeded$iv":Landroidx/compose/ui/Modifier;
    const/4 v13, 0x0

    .line 1317
    .local v13, "$i$f$clickableWithIndicationIfNeeded":I
    nop

    .line 1319
    instance-of v0, v11, Landroidx/compose/foundation/IndicationNodeFactory;

    if-eqz v0, :cond_0

    move-object v14, v11

    check-cast v14, Landroidx/compose/foundation/IndicationNodeFactory;

    .local v14, "indicationNodeFactory":Landroidx/compose/foundation/IndicationNodeFactory;
    move-object/from16 v1, p1
    ...
    .line 340
    .local v15, "$i$a$-clickableWithIndicationIfNeeded-ClickableKt$combinedClickable$3":I
    ...
    .line 1319
    .end local v1    # "intSource":Landroidx/compose/foundation/interaction/MutableInteractionSource;
    .end local v14    # "indicationNodeFactory":Landroidx/compose/foundation/IndicationNodeFactory;
    .end local v15    # "$i$a$-clickableWithIndicationIfNeeded-ClickableKt$combinedClickable$3":I
    move-object/from16 v0, v16
    ...
    .restart local v14    # "indicationNodeFactory":Landroidx/compose/foundation/IndicationNodeFactory;
    move-object/from16 v1, p1
    ...
    .line 340
    .restart local v15    # "$i$a$-clickableWithIndicationIfNeeded-ClickableKt$combinedClickable$3":I
    new-instance v16, Landroidx/compose/foundation/CombinedClickableElement;
    ...
    invoke-static {v0, v1, v11}, Landroidx/compose/foundation/IndicationKt;->indication(Landroidx/compose/ui/Modifier;Landroidx/compose/foundation/interaction/InteractionSource;Landroidx/compose/foundation/Indication;)Landroidx/compose/ui/Modifier;
    ...
    .local v15, "indicationNodeFactory":Landroidx/compose/foundation/IndicationNodeFactory;
    move-object/from16 v1, p1
    ...
    .line 340
    .local v16, "$i$a$-clickableWithIndicationIfNeeded-ClickableKt$combinedClickable$3":I
    new-instance v17, Landroidx/compose/foundation/CombinedClickableElement;
    ...
    .line 1325
    .end local v1    # "intSource":Landroidx/compose/foundation/interaction/MutableInteractionSource;
    .end local v15    # "indicationNodeFactory":Landroidx/compose/foundation/IndicationNodeFactory;
    .end local v16    # "$i$a$-clickableWithIndicationIfNeeded-ClickableKt$combinedClickable$3":I
    ...
    .line 351
    .end local v12    # "$this$clickableWithIndicationIfNeeded$iv":Landroidx/compose/ui/Modifier;
    .end local v13    # "$i$f$clickableWithIndicationIfNeeded":I
    return-object v0
.end method
...
.method public static final combinedClickable-cJG_KMw(Landroidx/compose/ui/Modifier;ZLjava/lang/String;Landroidx/compose/ui/semantics/Role;Ljava/lang/String;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;)Landroidx/compose/ui/Modifier;
    .locals 10
    .param p0, "$this$combinedClickable_u2dcJG_KMw"    # Landroidx/compose/ui/Modifier;
    .param p1, "enabled"    # Z
    .param p2, "onClickLabel"    # Ljava/lang/String;
    .param p3, "role"    # Landroidx/compose/ui/semantics/Role;
    ...
    .end local v0    # "$i$f$debugInspectorInfo":I
    :goto_0
    new-instance v0, Landroidx/compose/foundation/ClickableKt$combinedClickable$2;
...
.method public static final genericClickableWithoutGesture-Kqv-Bsg(Landroidx/compose/ui/Modifier;Landroidx/compose/foundation/interaction/MutableInteractionSource;Landroidx/compose/foundation/Indication;Lkotlinx/coroutines/CoroutineScope;Ljava/util/Map;Landroidx/compose/runtime/State;ZLjava/lang/String;Landroidx/compose/ui/semantics/Role;Ljava/lang/String;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;)Landroidx/compose/ui/Modifier;
    .locals 16
    .param p0, "$this$genericClickableWithoutGesture_u2dKqv_u2dBsg"    # Landroidx/compose/ui/Modifier;
    .param p1, "interactionSource"    # Landroidx/compose/foundation/interaction/MutableInteractionSource;
    .param p2, "indication"    # Landroidx/compose/foundation/Indication;
    .param p3, "indicationScope"    # Lkotlinx/coroutines/CoroutineScope;
    .param p4, "currentKeyPressInteractions"    # Ljava/util/Map;
    .param p5, "keyClickOffset"    # Landroidx/compose/runtime/State;
    .param p6, "enabled"    # Z
    .param p7, "onClickLabel"    # Ljava/lang/String;
    .param p8, "role"    # Landroidx/compose/ui/semantics/Role;
    .param p9, "onLongClickLabel"    # Ljava/lang/String;
    .param p10, "onLongClick"    # Lkotlin/jvm/functions/Function0;
    .param p11, "onClick"    # Lkotlin/jvm/functions/Function0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroidx/compose/ui/Modifier;",
...
.method private static final genericClickableWithoutGesture_Kqv_Bsg$detectPressAndClickFromKey(Landroidx/compose/ui/Modifier;ZLjava/util/Map;Landroidx/compose/runtime/State;Lkotlinx/coroutines/CoroutineScope;Lkotlin/jvm/functions/Function0;Landroidx/compose/foundation/interaction/MutableInteractionSource;)Landroidx/compose/ui/Modifier;
    .locals 8
    .param p0, "$this$genericClickableWithoutGesture_Kqv_Bsg_u24detectPressAndClickFromKey"    # Landroidx/compose/ui/Modifier;
    .param p1, "$enabled"    # Z
...
.method public static final hasScrollableContainer(Landroidx/compose/ui/node/TraversableNode;)Z
    .locals 4
    .param p0, "$this$hasScrollableContainer"    # Landroidx/compose/ui/node/TraversableNode;
    ...
    .line 1295
    .local v0, "hasScrollable":Lkotlin/jvm/internal/Ref$BooleanRef;
    move-object v1, p0
    ...
    new-instance v3, Landroidx/compose/foundation/ClickableKt$hasScrollableContainer$1;

    invoke-direct {v3, v0}, Landroidx/compose/foundation/ClickableKt$hasScrollableContainer$1;-><init>(Lkotlin/jvm/internal/Ref$BooleanRef;)V

    check-cast v3, Lkotlin/jvm/functions/Function1;

    invoke-static {v1, v2, v3}, Landroidx/compose/ui/node/TraversableNodeKt;->traverseAncestors(Landroidx/compose/ui/node/DelegatableNode;Ljava/lang/Object;Lkotlin/jvm/functions/Function1;)V
