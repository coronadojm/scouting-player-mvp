...
.method public final invoke(Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;I)Landroidx/compose/ui/Modifier;
    ...
    .line 246
    .local v9, "$i$a$-cache-TextFieldKeyInputKt$textFieldKeyInput$2$preparedSelectionState$1":I
    new-instance v10, Landroidx/compose/foundation/text/selection/TextPreparedSelectionState;

    invoke-direct {v10}, Landroidx/compose/foundation/text/selection/TextPreparedSelectionState;-><init>()V

    .line 266
    .end local v9    # "$i$a$-cache-TextFieldKeyInputKt$textFieldKeyInput$2$preparedSelectionState$1":I
    move-object v9, v10
    ...
    .line 247
    .local v10, "$i$a$-cache-TextFieldKeyInputKt$textFieldKeyInput$2$keyCombiner$1":I
    new-instance v11, Landroidx/compose/foundation/text/DeadKeyCombiner;

    invoke-direct {v11}, Landroidx/compose/foundation/text/DeadKeyCombiner;-><init>()V

    .line 272
    .end local v10    # "$i$a$-cache-TextFieldKeyInputKt$textFieldKeyInput$2$keyCombiner$1":I
    move-object v10, v11
    ...
    .line 248
    new-instance v6, Landroidx/compose/foundation/text/TextFieldKeyInput;

    .line 249
    iget-object v11, v0, Landroidx/compose/foundation/text/TextFieldKeyInputKt$textFieldKeyInput$2;->$state:Landroidx/compose/foundation/text/LegacyTextFieldState;

    .line 250
    iget-object v12, v0, Landroidx/compose/foundation/text/TextFieldKeyInputKt$textFieldKeyInput$2;->$manager:Landroidx/compose/foundation/text/selection/TextFieldSelectionManager;

    .line 251
    iget-object v13, v0, Landroidx/compose/foundation/text/TextFieldKeyInputKt$textFieldKeyInput$2;->$value:Landroidx/compose/ui/text/input/TextFieldValue;

    .line 252
    iget-boolean v14, v0, Landroidx/compose/foundation/text/TextFieldKeyInputKt$textFieldKeyInput$2;->$editable:Z

    .line 253
    iget-boolean v15, v0, Landroidx/compose/foundation/text/TextFieldKeyInputKt$textFieldKeyInput$2;->$singleLine:Z

    .line 255
    nop

    .line 254
    iget-object v7, v0, Landroidx/compose/foundation/text/TextFieldKeyInputKt$textFieldKeyInput$2;->$offsetMapping:Landroidx/compose/ui/text/input/OffsetMapping;

    .line 256
    iget-object v8, v0, Landroidx/compose/foundation/text/TextFieldKeyInputKt$textFieldKeyInput$2;->$undoManager:Landroidx/compose/foundation/text/UndoManager;
    ...
    .line 258
    iget-object v9, v0, Landroidx/compose/foundation/text/TextFieldKeyInputKt$textFieldKeyInput$2;->$onValueChange:Lkotlin/jvm/functions/Function1;

    .line 259
    iget v10, v0, Landroidx/compose/foundation/text/TextFieldKeyInputKt$textFieldKeyInput$2;->$imeAction:I
    ...
    invoke-direct/range {v10 .. v24}, Landroidx/compose/foundation/text/TextFieldKeyInput;-><init>(Landroidx/compose/foundation/text/LegacyTextFieldState;Landroidx/compose/foundation/text/selection/TextFieldSelectionManager;Landroidx/compose/ui/text/input/TextFieldValue;ZZLandroidx/compose/foundation/text/selection/TextPreparedSelectionState;Landroidx/compose/ui/text/input/OffsetMapping;Landroidx/compose/foundation/text/UndoManager;Landroidx/compose/foundation/text/DeadKeyCombiner;Landroidx/compose/foundation/text/KeyMapping;Lkotlin/jvm/functions/Function1;IILkotlin/jvm/internal/DefaultConstructorMarker;)V

    .line 261
    .local v6, "processor":Landroidx/compose/foundation/text/TextFieldKeyInput;
    ...
    .line 261
    .local v12, "$i$a$-cache-TextFieldKeyInputKt$textFieldKeyInput$2$1":I
    new-instance v13, Landroidx/compose/foundation/text/TextFieldKeyInputKt$textFieldKeyInput$2$1$1;

    invoke-direct {v13, v6}, Landroidx/compose/foundation/text/TextFieldKeyInputKt$textFieldKeyInput$2$1$1;-><init>(Ljava/lang/Object;)V

    check-cast v13, Lkotlin/reflect/KFunction;

    .line 278
    .end local v12    # "$i$a$-cache-TextFieldKeyInputKt$textFieldKeyInput$2$1":I
    move-object v12, v13
    ...
    invoke-static {v7, v12}, Landroidx/compose/ui/input/key/KeyInputModifierKt;->onKeyEvent(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function1;)Landroidx/compose/ui/Modifier;
