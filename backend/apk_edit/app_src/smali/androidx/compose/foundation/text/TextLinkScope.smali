...
# direct methods
.method public static synthetic $r8$lambda$wUliv7MpU312Vdu_yMFwbwK7l9M(Landroidx/compose/foundation/text/TextLinkScope;IILandroidx/compose/foundation/text/TextRangeLayoutMeasureScope;)Landroidx/compose/foundation/text/TextRangeLayoutMeasureResult;
    .locals 0
...
.method public constructor <init>(Landroidx/compose/ui/text/AnnotatedString;)V
    ...
    .local v1, "builder":Landroidx/compose/ui/text/AnnotatedString$Builder;
    const/4 v2, 0x0

    .line 74
    .local v2, "$i$a$-also-TextLinkScope$text$1":I
    iget-object v3, p0, Landroidx/compose/foundation/text/TextLinkScope;->initialText:Landroidx/compose/ui/text/AnnotatedString;
    ...
    invoke-virtual {v3, v5, v4}, Landroidx/compose/ui/text/AnnotatedString;->getLinkAnnotations(II)Ljava/util/List;
    ...
    .local v8, "link":Landroidx/compose/ui/text/AnnotatedString$Range;
    const/4 v9, 0x0

    .line 75
    .local v9, "$i$a$-fastForEach-TextLinkScope$text$1$1":I
    ...
    invoke-virtual {v10}, Landroidx/compose/ui/text/LinkAnnotation;->getStyles()Landroidx/compose/ui/text/TextLinkStyles;

    move-result-object v10

    if-eqz v10, :cond_0

    invoke-virtual {v10}, Landroidx/compose/ui/text/TextLinkStyles;->getStyle()Landroidx/compose/ui/text/SpanStyle;

    move-result-object v10

    if-eqz v10, :cond_0

    .local v10, "style":Landroidx/compose/ui/text/SpanStyle;
    const/4 v11, 0x0

    .line 76
    .local v11, "$i$a$-let-TextLinkScope$text$1$1$1":I
    ...
    invoke-virtual {v1, v10, v12, v13}, Landroidx/compose/ui/text/AnnotatedString$Builder;->addStyle(Landroidx/compose/ui/text/SpanStyle;II)V

    .line 77
    nop

    .line 75
    .end local v10    # "style":Landroidx/compose/ui/text/SpanStyle;
    .end local v11    # "$i$a$-let-TextLinkScope$text$1$1$1":I
    :cond_0
    nop
    ...
    .line 309
    .end local v8    # "link":Landroidx/compose/ui/text/AnnotatedString$Range;
    .end local v9    # "$i$a$-fastForEach-TextLinkScope$text$1$1":I
    nop
    ...
    .line 73
    .end local v1    # "builder":Landroidx/compose/ui/text/AnnotatedString$Builder;
    .end local v2    # "$i$a$-also-TextLinkScope$text$1":I
    nop
...
.method public final LinksComposables(Landroidx/compose/runtime/Composer;I)V
    ...
    invoke-virtual {v5, v8, v7}, Landroidx/compose/ui/text/AnnotatedString;->getLinkAnnotations(II)Ljava/util/List;
    ...
    .local v13, "range":Landroidx/compose/ui/text/AnnotatedString$Range;
    const/4 v14, 0x0

    .line 159
    .local v14, "$i$a$-fastForEach-TextLinkScope$LinksComposables$1":I
    ...
    .line 160
    invoke-direct {v0, v13}, Landroidx/compose/foundation/text/TextLinkScope;->shapeForRange(Landroidx/compose/ui/text/AnnotatedString$Range;)Landroidx/compose/ui/graphics/Shape;
    ...
    .line 320
    .local v15, "it":Landroidx/compose/ui/graphics/Shape;
    const/16 v16, 0x0

    .line 161
    .local v16, "$i$a$-let-TextLinkScope$LinksComposables$1$clipModifier$1":I
    ...
    invoke-static {v8, v15}, Landroidx/compose/ui/draw/ClipKt;->clip(Landroidx/compose/ui/Modifier;Landroidx/compose/ui/graphics/Shape;)Landroidx/compose/ui/Modifier;

    move-result-object v8

    .end local v15    # "it":Landroidx/compose/ui/graphics/Shape;
    .end local v16    # "$i$a$-let-TextLinkScope$LinksComposables$1$clipModifier$1":I
    if-nez v8, :cond_6
    ...
    .line 162
    .local v8, "clipModifier":Landroidx/compose/ui/Modifier;
    :cond_6
    const v15, -0x161d14c5

    move-object/from16 v16, v5

    .end local v5    # "links":Ljava/util/List;
    .local v16, "links":Ljava/util/List;
    const-string v5, "CC(remember):TextLinkScope.kt#9igjgp"
    ...
    .line 162
    .local v7, "$i$a$-cache-TextLinkScope$LinksComposables$1$interactionSource$1":I
    invoke-static {}, Landroidx/compose/foundation/interaction/InteractionSourceKt;->MutableInteractionSource()Landroidx/compose/foundation/interaction/MutableInteractionSource;

    move-result-object v7

    .line 323
    .end local v7    # "$i$a$-cache-TextLinkScope$LinksComposables$1$interactionSource$1":I
    nop
    ...
    invoke-direct {v0, v8, v7, v15}, Landroidx/compose/foundation/text/TextLinkScope;->textRange(Landroidx/compose/ui/Modifier;II)Landroidx/compose/ui/Modifier;
    ...
    .end local v8    # "clipModifier":Landroidx/compose/ui/Modifier;
    .end local v9    # "$i$f$fastForEach":I
    .local v17, "clipModifier":Landroidx/compose/ui/Modifier;
    .local p1, "$i$f$fastForEach":I
    invoke-static {v7, v6, v9, v8, v15}, Landroidx/compose/foundation/HoverableKt;->hoverable$default(Landroidx/compose/ui/Modifier;Landroidx/compose/foundation/interaction/MutableInteractionSource;ZILjava/lang/Object;)Landroidx/compose/ui/Modifier;
    ...
    invoke-static {v7, v11, v9, v8, v15}, Landroidx/compose/ui/input/pointer/PointerIconKt;->pointerHoverIcon$default(Landroidx/compose/ui/Modifier;Landroidx/compose/ui/input/pointer/PointerIcon;ZILjava/lang/Object;)Landroidx/compose/ui/Modifier;

    move-result-object v7

    .line 170
    sget-object v11, Landroidx/compose/foundation/text/TextLinkScope$LinksComposables$1$1;->INSTANCE:Landroidx/compose/foundation/text/TextLinkScope$LinksComposables$1$1;

    check-cast v11, Lkotlin/jvm/functions/Function1;

    const/4 v8, 0x1

    invoke-static {v7, v9, v11, v8, v15}, Landroidx/compose/ui/semantics/SemanticsModifierKt;->semantics$default(Landroidx/compose/ui/Modifier;ZLkotlin/jvm/functions/Function1;ILjava/lang/Object;)Landroidx/compose/ui/Modifier;
    ...
    .line 174
    .local v15, "$i$a$-cache-TextLinkScope$LinksComposables$1$2":I
    move/from16 v25, v7

    .end local v7    # "invalid$iv":Z
    .local v25, "invalid$iv":Z
    new-instance v7, Landroidx/compose/foundation/text/TextLinkScope$LinksComposables$1$2$1;

    invoke-direct {v7, v0, v13, v2}, Landroidx/compose/foundation/text/TextLinkScope$LinksComposables$1$2$1;-><init>(Landroidx/compose/foundation/text/TextLinkScope;Landroidx/compose/ui/text/AnnotatedString$Range;Landroidx/compose/ui/platform/UriHandler;)V

    check-cast v7, Lkotlin/jvm/functions/Function0;

    .line 329
    .end local v15    # "$i$a$-cache-TextLinkScope$LinksComposables$1$2":I
    nop
    ...
    .line 179
    .local v8, "$i$a$-cache-TextLinkScope$LinksComposables$1$linkStateObserver$1":I
    new-instance v22, Landroidx/compose/foundation/text/LinkStateInteractionSourceObserver;

    invoke-direct/range {v22 .. v22}, Landroidx/compose/foundation/text/LinkStateInteractionSourceObserver;-><init>()V

    .line 335
    .end local v8    # "$i$a$-cache-TextLinkScope$LinksComposables$1$linkStateObserver$1":I
    ...
    .local v7, "linkStateObserver":Landroidx/compose/foundation/text/LinkStateInteractionSourceObserver;
    invoke-static {v3}, Landroidx/compose/runtime/ComposerKt;->sourceInformationMarkerEnd(Landroidx/compose/runtime/Composer;)V

    .line 180
    const v8, -0x161ca35e

    invoke-static {v3, v8, v5}, Landroidx/compose/runtime/ComposerKt;->sourceInformationMarkerStart(Landroidx/compose/runtime/Composer;ILjava/lang/String;)V
    ...
    .local v25, "uriHandler":Landroidx/compose/ui/platform/UriHandler;
    invoke-virtual/range {v22 .. v22}, Landroidx/compose/runtime/Composer$Companion;->getEmpty()Ljava/lang/Object;
    ...
    .line 180
    .local v2, "$i$a$-cache-TextLinkScope$LinksComposables$1$3":I
    move/from16 v22, v2

    .end local v2    # "$i$a$-cache-TextLinkScope$LinksComposables$1$3":I
    .local v22, "$i$a$-cache-TextLinkScope$LinksComposables$1$3":I
    new-instance v2, Landroidx/compose/foundation/text/TextLinkScope$LinksComposables$1$3$1;
    ...
    invoke-direct {v2, v7, v6, v8}, Landroidx/compose/foundation/text/TextLinkScope$LinksComposables$1$3$1;-><init>(Landroidx/compose/foundation/text/LinkStateInteractionSourceObserver;Landroidx/compose/foundation/interaction/MutableInteractionSource;Lkotlin/coroutines/Continuation;)V
    ...
    .end local v8    # "invalid$iv":Z
    .restart local v26    # "invalid$iv":Z
    move-object v2, v15
    ...
    invoke-static {v6, v2, v3, v9}, Landroidx/compose/runtime/EffectsKt;->LaunchedEffect(Ljava/lang/Object;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;I)V
    ...
    invoke-virtual {v2}, Landroidx/compose/ui/text/TextLinkStyles;->getStyle()Landroidx/compose/ui/text/SpanStyle;
    ...
    .line 192
    .local v5, "$i$a$-cache-TextLinkScope$LinksComposables$1$4":I
    move/from16 v18, v5

    .end local v5    # "$i$a$-cache-TextLinkScope$LinksComposables$1$4":I
    .local v18, "$i$a$-cache-TextLinkScope$LinksComposables$1$4":I
    new-instance v5, Landroidx/compose/foundation/text/TextLinkScope$LinksComposables$1$4$1;

    invoke-direct {v5, v0, v13, v7}, Landroidx/compose/foundation/text/TextLinkScope$LinksComposables$1$4$1;-><init>(Landroidx/compose/foundation/text/TextLinkScope;Landroidx/compose/ui/text/AnnotatedString$Range;Landroidx/compose/foundation/text/LinkStateInteractionSourceObserver;)V

    check-cast v5, Lkotlin/jvm/functions/Function1;

    .line 347
    .end local v18    # "$i$a$-cache-TextLinkScope$LinksComposables$1$4":I
    nop
    ...
    .line 184
    invoke-direct {v0, v2, v5, v3, v8}, Landroidx/compose/foundation/text/TextLinkScope;->StyleAnnotation([Ljava/lang/Object;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;I)V

    .line 178
    .end local v7    # "linkStateObserver":Landroidx/compose/foundation/text/LinkStateInteractionSourceObserver;
    invoke-interface {v3}, Landroidx/compose/runtime/Composer;->endReplaceGroup()V

    goto :goto_e

    .line 215
    .end local v25    # "uriHandler":Landroidx/compose/ui/platform/UriHandler;
    .local v2, "uriHandler":Landroidx/compose/ui/platform/UriHandler;
    :cond_12
    move-object/from16 v25, v2

    .end local v2    # "uriHandler":Landroidx/compose/ui/platform/UriHandler;
    .restart local v25    # "uriHandler":Landroidx/compose/ui/platform/UriHandler;
    const v2, 0x52a3520e
    ...
    .end local v17    # "clipModifier":Landroidx/compose/ui/Modifier;
    ...
    .line 216
    .end local v16    # "links":Ljava/util/List;
    ...
    .end local v7    # "$this$fastForEach$iv":Ljava/util/List;
    .end local v9    # "$i$f$fastForEach":I
    .restart local v16    # "links":Ljava/util/List;
    ...
    .line 319
    .end local v13    # "range":Landroidx/compose/ui/text/AnnotatedString$Range;
    .end local v14    # "$i$a$-fastForEach-TextLinkScope$LinksComposables$1":I
    nop
    ...
    new-instance v5, Landroidx/compose/foundation/text/TextLinkScope$LinksComposables$2;

    invoke-direct {v5, v0, v1}, Landroidx/compose/foundation/text/TextLinkScope$LinksComposables$2;-><init>(Landroidx/compose/foundation/text/TextLinkScope;I)V
...
.method public final applyAnnotators$foundation_release()Landroidx/compose/ui/text/AnnotatedString;
    ...
    .local v2, "$this$applyAnnotators_u24lambda_u2414":Landroidx/compose/ui/text/AnnotatedString$Builder;
    const/4 v3, 0x0
    ...
    .line 352
    .end local v2    # "$this$applyAnnotators_u24lambda_u2414":Landroidx/compose/ui/text/AnnotatedString$Builder;
