...
.method public static final InlineChildren(Landroidx/compose/ui/text/AnnotatedString;Ljava/util/List;Landroidx/compose/runtime/Composer;I)V
    ...
    .param p1, "inlineContents"    # Ljava/util/List;
    ...
    .line 75
    .local v11, "$i$a$-fastForEach-AnnotatedStringResolveInlineContentKt$InlineChildren$1":I
    ...
    .line 76
    .local v10, "end":I
    sget-object v14, Landroidx/compose/foundation/text/AnnotatedStringResolveInlineContentKt$InlineChildren$1$2;->INSTANCE:Landroidx/compose/foundation/text/AnnotatedStringResolveInlineContentKt$InlineChildren$1$2;
    ...
    .local v27, "$this$set_impl_u24lambda_u240$iv$iv":Landroidx/compose/runtime/Composer;
    const/16 v28, 0x0
    ...
    .end local v11    # "$i$a$-fastForEach-AnnotatedStringResolveInlineContentKt$InlineChildren$1":I
    .local v30, "$i$a$-fastForEach-AnnotatedStringResolveInlineContentKt$InlineChildren$1":I
    ...
    .end local v30    # "$i$a$-fastForEach-AnnotatedStringResolveInlineContentKt$InlineChildren$1":I
    .restart local v5    # "localMap$iv":Landroidx/compose/runtime/CompositionLocalMap;
    .restart local v11    # "$i$a$-fastForEach-AnnotatedStringResolveInlineContentKt$InlineChildren$1":I
    :cond_a
    move-object/from16 v29, v5
    ...
    .restart local v30    # "$i$a$-fastForEach-AnnotatedStringResolveInlineContentKt$InlineChildren$1":I
    :goto_5
    invoke-static/range {v18 .. v18}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;
    ...
    .end local v27    # "$this$set_impl_u24lambda_u240$iv$iv":Landroidx/compose/runtime/Composer;
    ...
    invoke-interface {v9, v5, v8}, Landroidx/compose/runtime/Composer;->apply(Ljava/lang/Object;Lkotlin/jvm/functions/Function2;)V
    ...
    .line 77
    .local v9, "$i$a$-Layout-AnnotatedStringResolveInlineContentKt$InlineChildren$1$1":I
    const v11, 0xf450b9c
    ...
    invoke-virtual {v0, v13, v10}, Landroidx/compose/ui/text/AnnotatedString;->subSequence(II)Landroidx/compose/ui/text/AnnotatedString;
    ...
    invoke-interface {v12, v3, v8, v11}, Lkotlin/jvm/functions/Function3;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local v9    # "$i$a$-Layout-AnnotatedStringResolveInlineContentKt$InlineChildren$1$1":I
    nop
    ...
    new-instance v5, Landroidx/compose/foundation/text/AnnotatedStringResolveInlineContentKt$InlineChildren$2;

    invoke-direct {v5, v0, v1, v2}, Landroidx/compose/foundation/text/AnnotatedStringResolveInlineContentKt$InlineChildren$2;-><init>(Landroidx/compose/ui/text/AnnotatedString;Ljava/util/List;I)V
...
.method public static final hasInlineContent(Landroidx/compose/ui/text/AnnotatedString;)Z
    .locals 3
    .param p0, "$this$hasInlineContent"    # Landroidx/compose/ui/text/AnnotatedString;
...
.method public static final resolveInlineContent(Landroidx/compose/ui/text/AnnotatedString;Ljava/util/Map;)Lkotlin/Pair;
    .locals 17
    .param p0, "$this$resolveInlineContent"    # Landroidx/compose/ui/text/AnnotatedString;
    .param p1, "inlineContent"    # Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroidx/compose/ui/text/AnnotatedString;",
    ...
    invoke-virtual {v4, v3, v1, v2}, Landroidx/compose/ui/text/AnnotatedString;->getStringAnnotations(Ljava/lang/String;II)Ljava/util/List;

    move-result-object v1

    .line 44
    .local v1, "inlineContentAnnotations":Ljava/util/List;
    ...
    .line 46
    .local v3, "inlineComposables":Ljava/util/List;
    move-object v5, v1
    ...
    .line 47
    .local v11, "$i$a$-fastForEach-AnnotatedStringResolveInlineContentKt$resolveInlineContent$1":I
    ...
    check-cast v12, Landroidx/compose/foundation/text/InlineTextContent;

    if-eqz v12, :cond_3

    .local v12, "inlineTextContent":Landroidx/compose/foundation/text/InlineTextContent;
    const/4 v13, 0x0

    .line 48
    .local v13, "$i$a$-let-AnnotatedStringResolveInlineContentKt$resolveInlineContent$1$1":I
    nop
    ...
    .line 50
    invoke-virtual {v12}, Landroidx/compose/foundation/text/InlineTextContent;->getPlaceholder()Landroidx/compose/ui/text/Placeholder;
    ...
    .end local v1    # "inlineContentAnnotations":Ljava/util/List;
    .local v16, "inlineContentAnnotations":Ljava/util/List;
    invoke-virtual {v10}, Landroidx/compose/ui/text/AnnotatedString$Range;->getEnd()I

    move-result v1

    .line 49
    invoke-direct {v14, v15, v0, v1}, Landroidx/compose/ui/text/AnnotatedString$Range;-><init>(Ljava/lang/Object;II)V
    ...
    .line 57
    invoke-virtual {v12}, Landroidx/compose/foundation/text/InlineTextContent;->getChildren()Lkotlin/jvm/functions/Function3;
    ...
    .line 56
    invoke-direct {v0, v1, v14, v15}, Landroidx/compose/ui/text/AnnotatedString$Range;-><init>(Ljava/lang/Object;II)V
    ...
    .end local v12    # "inlineTextContent":Landroidx/compose/foundation/text/InlineTextContent;
    .end local v13    # "$i$a$-let-AnnotatedStringResolveInlineContentKt$resolveInlineContent$1$1":I
    goto :goto_3

    .line 47
    .end local v16    # "inlineContentAnnotations":Ljava/util/List;
    .restart local v1    # "inlineContentAnnotations":Ljava/util/List;
    :cond_3
    move-object/from16 v16, v1

    .end local v1    # "inlineContentAnnotations":Ljava/util/List;
    .restart local v16    # "inlineContentAnnotations":Ljava/util/List;
    :goto_3
    nop
    ...
    .end local v11    # "$i$a$-fastForEach-AnnotatedStringResolveInlineContentKt$resolveInlineContent$1":I
    nop
