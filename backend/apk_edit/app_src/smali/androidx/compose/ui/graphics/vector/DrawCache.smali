...
.method static constructor <clinit>()V
    ...
    sput v0, Landroidx/compose/ui/graphics/vector/DrawCache;->$stable:I
...
.method public final drawCachedImage-FqjB98A(IJLandroidx/compose/ui/unit/Density;Landroidx/compose/ui/unit/LayoutDirection;Lkotlin/jvm/functions/Function1;)V
    ...
    .line 66
    iget-object v11, v0, Landroidx/compose/ui/graphics/vector/DrawCache;->mCachedImage:Landroidx/compose/ui/graphics/ImageBitmap;

    .line 67
    .local v11, "targetImage":Landroidx/compose/ui/graphics/ImageBitmap;
    iget-object v12, v0, Landroidx/compose/ui/graphics/vector/DrawCache;->cachedCanvas:Landroidx/compose/ui/graphics/Canvas;

    .line 68
    .local v12, "targetCanvas":Landroidx/compose/ui/graphics/Canvas;
    if-eqz v11, :cond_0
    ...
    invoke-interface {v11}, Landroidx/compose/ui/graphics/ImageBitmap;->getWidth()I
    ...
    invoke-interface {v11}, Landroidx/compose/ui/graphics/ImageBitmap;->getHeight()I
    ...
    .line 72
    iget v1, v0, Landroidx/compose/ui/graphics/vector/DrawCache;->config:I

    invoke-static {v1, v8}, Landroidx/compose/ui/graphics/ImageBitmapConfig;->equals-impl0(II)Z
    ...
    .line 75
    invoke-static {v11}, Landroidx/compose/ui/graphics/CanvasKt;->Canvas(Landroidx/compose/ui/graphics/ImageBitmap;)Landroidx/compose/ui/graphics/Canvas;

    move-result-object v12

    .line 77
    iput-object v11, v0, Landroidx/compose/ui/graphics/vector/DrawCache;->mCachedImage:Landroidx/compose/ui/graphics/ImageBitmap;

    .line 78
    iput-object v12, v0, Landroidx/compose/ui/graphics/vector/DrawCache;->cachedCanvas:Landroidx/compose/ui/graphics/Canvas;
    ...
    iput-wide v1, v0, Landroidx/compose/ui/graphics/vector/DrawCache;->size:J
    ...
    invoke-virtual {v7, v9}, Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope$DrawParams;->setDensity(Landroidx/compose/ui/unit/Density;)V

    .line 117
    invoke-virtual {v7, v10}, Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope$DrawParams;->setLayoutDirection(Landroidx/compose/ui/unit/LayoutDirection;)V

    .line 118
    invoke-virtual {v7, v12}, Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope$DrawParams;->setCanvas(Landroidx/compose/ui/graphics/Canvas;)V

    .line 119
    invoke-virtual {v7, v4, v5}, Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope$DrawParams;->setSize-uvyYCjk(J)V
    ...
    .local v7, "$this$drawCachedImage_FqjB98A_u24lambda_u240":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    const/16 v16, 0x0

    .line 83
    .local v16, "$i$a$-draw-yzxVdVo-DrawCache$drawCachedImage$1":I
    invoke-direct {v0, v7}, Landroidx/compose/ui/graphics/vector/DrawCache;->clear(Landroidx/compose/ui/graphics/drawscope/DrawScope;)V
    ...
    .line 122
    .end local v7    # "$this$drawCachedImage_FqjB98A_u24lambda_u240":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    ...
    invoke-virtual {v7, v13}, Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope$DrawParams;->setDensity(Landroidx/compose/ui/unit/Density;)V

    .line 126
    invoke-virtual {v7, v14}, Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope$DrawParams;->setLayoutDirection(Landroidx/compose/ui/unit/LayoutDirection;)V

    .line 127
    invoke-virtual {v7, v15}, Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope$DrawParams;->setCanvas(Landroidx/compose/ui/graphics/Canvas;)V

    .line 128
    invoke-virtual {v7, v1, v2}, Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope$DrawParams;->setSize-uvyYCjk(J)V
    ...
    .end local v6    # "$i$f$draw-yzxVdVo":I
...
.method public final drawInto(Landroidx/compose/ui/graphics/drawscope/DrawScope;FLandroidx/compose/ui/graphics/ColorFilter;)V
    ...
    iget-object v13, v0, Landroidx/compose/ui/graphics/vector/DrawCache;->mCachedImage:Landroidx/compose/ui/graphics/ImageBitmap;

    .line 98
    .local v13, "targetImage":Landroidx/compose/ui/graphics/ImageBitmap;
    if-eqz v13, :cond_0
    ...
    .line 99
    .local v3, "$i$a$-checkPrecondition-DrawCache$drawInto$1":I
    nop

    .line 135
    .end local v3    # "$i$a$-checkPrecondition-DrawCache$drawInto$1":I
    ...
    .end local v13    # "targetImage":Landroidx/compose/ui/graphics/ImageBitmap;
    .local v18, "targetImage":Landroidx/compose/ui/graphics/ImageBitmap;
