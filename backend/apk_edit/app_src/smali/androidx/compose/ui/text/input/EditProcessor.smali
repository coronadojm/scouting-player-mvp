...
.method private final generateBatchErrorMessage(Ljava/util/List;Landroidx/compose/ui/text/input/EditCommand;)Ljava/lang/String;
    ...
    .local v2, "$this$generateBatchErrorMessage_u24lambda_u243":Ljava/lang/StringBuilder;
    const/4 v3, 0x0
    ...
    .line 146
    .end local v2    # "$this$generateBatchErrorMessage_u24lambda_u243":Ljava/lang/StringBuilder;
...
.method public final apply(Ljava/util/List;)Landroidx/compose/ui/text/input/TextFieldValue;
    ...
    invoke-virtual {v1}, Landroidx/compose/ui/text/input/EditingBuffer;->toAnnotatedString$ui_text_release()Landroidx/compose/ui/text/AnnotatedString;
    ...
    .local v1, "$this$apply_u24lambda_u242":J
    const/4 v4, 0x0

    .line 129
    .local v4, "$i$a$-run-EditProcessor$apply$newState$1":I
    ...
    .line 128
    .end local v1    # "$this$apply_u24lambda_u242":J
    .end local v4    # "$i$a$-run-EditProcessor$apply$newState$1":I
    nop
