...
.method public constructor <init>(I)V
    ...
    .line 684
    .local v2, "$i$a$-requirePrecondition-MutableLongLongMap$1":I
    nop

    .line 1134
    .end local v2    # "$i$a$-requirePrecondition-MutableLongLongMap$1":I
    ...
    invoke-direct {p0, v0}, Landroidx/collection/MutableLongLongMap;->initializeStorage(I)V
...
.method private final adjustStorage()V
    ...
    .line 984
    iget v0, p0, Landroidx/collection/MutableLongLongMap;->_capacity:I

    const/16 v1, 0x8

    if-le v0, v1, :cond_0

    iget v0, p0, Landroidx/collection/MutableLongLongMap;->_size:I
    ...
    iget v2, p0, Landroidx/collection/MutableLongLongMap;->_capacity:I
...
.method private final dropDeletes()V
    ...
    iget-object v1, v0, Landroidx/collection/MutableLongLongMap;->metadata:[J

    .line 993
    .local v1, "metadata":[J
    iget v2, v0, Landroidx/collection/MutableLongLongMap;->_capacity:I

    .line 994
    .local v2, "capacity":I
    iget-object v3, v0, Landroidx/collection/MutableLongLongMap;->keys:[J

    .line 995
    .local v3, "keys":[J
    iget-object v4, v0, Landroidx/collection/MutableLongLongMap;->values:[J
    ...
    .line 1022
    .local v14, "hash1":I
    invoke-direct {v0, v14}, Landroidx/collection/MutableLongLongMap;->findFirstAvailableSlot(I)I
...
.method private final findFirstAvailableSlot(I)I
    ...
    .line 949
    iget-object v3, p0, Landroidx/collection/MutableLongLongMap;->metadata:[J
...
.method private final findInsertIndex(J)I
    ...
    .line 903
    .local v3, "hash2":I
    iget v4, v0, Landroidx/collection/MutableLongLongMap;->_capacity:I
    ...
    .line 908
    iget-object v7, v0, Landroidx/collection/MutableLongLongMap;->metadata:[J
    ...
    .line 912
    .local v11, "index":I
    iget-object v12, v0, Landroidx/collection/MutableLongLongMap;->keys:[J
    ...
    .line 927
    .local v7, "index":I
    iget v8, v0, Landroidx/collection/MutableLongLongMap;->growthLimit:I

    const-wide/16 v9, 0xff

    if-nez v8, :cond_4

    iget-object v8, v0, Landroidx/collection/MutableLongLongMap;->metadata:[J
    ...
    .line 932
    :cond_4
    iget v8, v0, Landroidx/collection/MutableLongLongMap;->_size:I

    add-int/lit8 v8, v8, 0x1

    iput v8, v0, Landroidx/collection/MutableLongLongMap;->_size:I

    .line 933
    iget v8, v0, Landroidx/collection/MutableLongLongMap;->growthLimit:I

    iget-object v11, v0, Landroidx/collection/MutableLongLongMap;->metadata:[J
    ...
    iput v8, v0, Landroidx/collection/MutableLongLongMap;->growthLimit:I

    .line 934
    iget-object v8, v0, Landroidx/collection/MutableLongLongMap;->metadata:[J

    .local v8, "data$iv":[J
    iget v11, v0, Landroidx/collection/MutableLongLongMap;->_capacity:I
...
.method private final initializeGrowth()V
    ...
    .line 717
    invoke-virtual {p0}, Landroidx/collection/MutableLongLongMap;->getCapacity()I
    ...
    iget v1, p0, Landroidx/collection/MutableLongLongMap;->_size:I
...
.method private final initializeMetadata(I)V
    ...
    .line 709
    .local v9, "$i$a$-apply-MutableLongLongMap$initializeMetadata$1":I
    const/4 v6, 0x6
    ...
    .end local v9    # "$i$a$-apply-MutableLongLongMap$initializeMetadata$1":I
    move-object v0, v8

    .line 703
    .end local v0    # "size":I
    :goto_0
    iput-object v0, p0, Landroidx/collection/MutableLongLongMap;->metadata:[J

    .line 712
    iget-object v0, p0, Landroidx/collection/MutableLongLongMap;->metadata:[J
...
.method private final initializeStorage(I)V
    ...
    iput v0, p0, Landroidx/collection/MutableLongLongMap;->_capacity:I

    .line 697
    invoke-direct {p0, v0}, Landroidx/collection/MutableLongLongMap;->initializeMetadata(I)V

    .line 698
    new-array v1, v0, [J

    iput-object v1, p0, Landroidx/collection/MutableLongLongMap;->keys:[J

    .line 699
    new-array v1, v0, [J

    iput-object v1, p0, Landroidx/collection/MutableLongLongMap;->values:[J
...
.method private final resizeStorage(I)V
    ...
    iget-object v2, v0, Landroidx/collection/MutableLongLongMap;->keys:[J

    .line 1092
    .local v2, "previousKeys":[J
    iget-object v3, v0, Landroidx/collection/MutableLongLongMap;->values:[J
    ...
    .line 1097
    iget-object v5, v0, Landroidx/collection/MutableLongLongMap;->metadata:[J

    .line 1098
    .local v5, "newMetadata":[J
    iget-object v6, v0, Landroidx/collection/MutableLongLongMap;->keys:[J

    .line 1099
    .local v6, "newKeys":[J
    iget-object v7, v0, Landroidx/collection/MutableLongLongMap;->values:[J

    .line 1100
    .local v7, "newValues":[J
    iget v8, v0, Landroidx/collection/MutableLongLongMap;->_capacity:I
...
.method private final writeMetadata(IJ)V
    ...
    iget-object v1, p0, Landroidx/collection/MutableLongLongMap;->metadata:[J
...
.method public final clear()V
    ...
    iput v0, p0, Landroidx/collection/MutableLongLongMap;->_size:I
    ...
    .line 885
    iget-object v2, p0, Landroidx/collection/MutableLongLongMap;->metadata:[J
    ...
    .local v0, "data$iv":[J
    iget v1, p0, Landroidx/collection/MutableLongLongMap;->_capacity:I
...
.method public final getOrPut(JLkotlin/jvm/functions/Function0;)J
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/collection/MutableLongLongMap;->findKeyIndex(J)I
    ...
    .line 730
    .local v2, "defValue":J
    invoke-virtual {p0, p1, p2, v2, v3}, Landroidx/collection/MutableLongLongMap;->put(JJ)V
    ...
    .line 733
    :cond_0
    iget-object v2, p0, Landroidx/collection/MutableLongLongMap;->values:[J
...
.method public final minusAssign(Landroidx/collection/LongList;)V
    ...
    .line 866
    .local v8, "$i$a$-forEach-MutableLongLongMap$minusAssign$2":I
    invoke-virtual {p0, v6, v7}, Landroidx/collection/MutableLongLongMap;->remove(J)V
    ...
    .line 1219
    .end local v6    # "key":J
    .end local v8    # "$i$a$-forEach-MutableLongLongMap$minusAssign$2":I
    nop
...
.method public final minusAssign(Landroidx/collection/LongSet;)V
    ...
    .line 857
    .local v19, "$i$a$-forEach-MutableLongLongMap$minusAssign$1":I
    move/from16 v20, v3
    ...
    invoke-virtual {v3, v1, v2}, Landroidx/collection/MutableLongLongMap;->remove(J)V
    ...
    .line 1207
    .end local v1    # "key":J
    .end local v19    # "$i$a$-forEach-MutableLongLongMap$minusAssign$1":I
    nop
...
.method public final minusAssign([J)V
    ...
    .line 848
    .local v3, "key":J
    invoke-virtual {p0, v3, v4}, Landroidx/collection/MutableLongLongMap;->remove(J)V
...
.method public final plusAssign(Landroidx/collection/LongLongMap;)V
    .locals 1
    .param p1, "from"    # Landroidx/collection/LongLongMap;
...
.method public final put(JJJ)J
    ...
    .line 778
    :cond_0
    iget-object v3, p0, Landroidx/collection/MutableLongLongMap;->values:[J

    aget-wide v1, v3, v0

    .line 780
    :goto_0
    iget-object v3, p0, Landroidx/collection/MutableLongLongMap;->keys:[J
...
.method public final putAll(Landroidx/collection/LongLongMap;)V
    ...
    .local v1, "key":J
    .local v19, "this_$iv$iv":Landroidx/collection/LongLongMap;
    ...
    .line 791
    .local v21, "$i$a$-forEach-MutableLongLongMap$putAll$1":I
    ...
    .end local v3    # "k$iv":[J
    .local v22, "k$iv":[J
    invoke-virtual {v3, v1, v2, v5, v6}, Landroidx/collection/MutableLongLongMap;->set(JJ)V
    ...
    .end local v21    # "$i$a$-forEach-MutableLongLongMap$putAll$1":I
    nop
    ...
    .end local v19    # "this_$iv$iv":Landroidx/collection/LongLongMap;
    ...
    .restart local v19    # "this_$iv$iv":Landroidx/collection/LongLongMap;
    ...
    .restart local v2    # "$i$f$forEach":I
    .restart local v3    # "k$iv":[J
    .restart local v5    # "this_$iv$iv":Landroidx/collection/LongLongMap;
    .restart local v6    # "$i$f$forEachIndexed":I
    :cond_2
    move/from16 v17, v2
...
.method public final remove(J)V
    ...
    .line 806
    invoke-virtual {p0, v0}, Landroidx/collection/MutableLongLongMap;->removeValueAt(I)V
...
.method public final remove(JJ)Z
    ...
    .line 817
    iget-object v1, p0, Landroidx/collection/MutableLongLongMap;->values:[J
...
.method public final removeIf(Lkotlin/jvm/functions/Function2;)V
    ...
    .line 830
    .local v15, "$i$a$-forEachIndexed-MutableLongLongMap$removeIf$1":I
    iget-object v11, v0, Landroidx/collection/MutableLongLongMap;->keys:[J
    ...
    iget-object v2, v0, Landroidx/collection/MutableLongLongMap;->values:[J
    ...
    .line 831
    invoke-virtual {v0, v14}, Landroidx/collection/MutableLongLongMap;->removeValueAt(I)V
    ...
    .end local v15    # "$i$a$-forEachIndexed-MutableLongLongMap$removeIf$1":I
    goto :goto_3
...
.method public final set(JJ)V
    ...
    .line 747
    :cond_0
    iget-object v1, p0, Landroidx/collection/MutableLongLongMap;->keys:[J
